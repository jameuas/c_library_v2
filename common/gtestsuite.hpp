...
TEST(common, SYS_IDEN_DATA)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::SYS_IDEN_DATA packet_in{};
    packet_in.p = 17.0;
    packet_in.q = 45.0;
    packet_in.r = 73.0;
    packet_in.ax = 101.0;
    ...
    packet_in.beta = 241.0;
    packet_in.ail = 269.0;
    packet_in.ele = 297.0;
    packet_in.rud = 325.0;

    mavlink::common::msg::SYS_IDEN_DATA packet1{};
    mavlink::common::msg::SYS_IDEN_DATA packet2{};
    ...
    EXPECT_EQ(packet1.ail, packet2.ail);
    EXPECT_EQ(packet1.ele, packet2.ele);
    EXPECT_EQ(packet1.rud, packet2.rud);
}

#ifdef TEST_INTEROP
TEST(common_interop, SYS_IDEN_DATA)
{
    mavlink_message_t msg;
    ...
    mavlink_sys_iden_data_t packet_c {
    ...
    mavlink_msg_sys_iden_data_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.ail, packet2.ail);
    EXPECT_EQ(packet_in.ele, packet2.ele);
    EXPECT_EQ(packet_in.rud, packet2.rud);
